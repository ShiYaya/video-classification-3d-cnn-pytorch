...
def main(opt, C3D_model, load_image_fn, C2D_model, c2d_shape):
    outputs = []
    ...
    for video_path in all_videos_path:
        if os.path.exists(video_path):
            ...
            if len(os.listdir(opt.tmp)) >= 1:
                ...
                c3d_features, c2d_features = extract_feature(opt, opt.tmp, C3D_model, load_image_fn, C2D_model, c2d_shape)
