...
class ResNeXt(nn.Module):
    ...
    def forward(self, x):
        # orign x.shape= torch.Size([8, 3, 16, 112, 112])
        # conv1 x.shape= torch.Size([8, 64, 16, 56, 56])
        # maxpool x.shape= torch.Size([8, 64, 8, 28, 28])
        # layer1 x.shape= torch.Size([8, 256, 8, 28, 28])
        # layer2 x.shape= torch.Size([8, 512, 4, 14, 14])
        # layer3 x.shape= torch.Size([8, 1024, 2, 7, 7])
        # layer4 x.shape= torch.Size([8, 2048, 1, 4, 4])
        # print('orign x.shape= {}'.format(x.shape))
        x = self.conv1(x)
